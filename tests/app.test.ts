...
describe('API boundary', () => {
  ...
  it('reports whether PowerSync replication is provisioned', async () => {
    ...
    expect((await provisioned.app.inject('/api/v1/health/ready')).json()).toEqual({ status: 'ready', scope: 'backend-sync', database: 'ready', sync: 'provisioned', assistant: 'disabled', transcription: 'disabled' });
